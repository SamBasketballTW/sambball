$(document).ready(function () {
    fetch('../data/standings-sbl.csv')
        ...
        .then((result) => {
            ...
            table = document.getElementById('sbl_tb');
            table_calendar = document.getElementById('calendar_sbl_tbody');

            rank = [];
            for (let i = 0; i < 4; i++) rank.push(sbl_team[i + 1]);
